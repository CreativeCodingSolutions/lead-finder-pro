...
<div class="max-w-4xl mx-auto px-4 py-16">
    ...
    <div class="prose prose-gray max-w-none space-y-6">
        ...
        <p>
            ...
            CreativeCodingSolutions, Musterstraße 123, 1010 Wien, Österreich.
        </p>
        ...
        <h2 class="text-xl font-semibold mt-8 mb-4">5. Kündigung</h2>
        <p>
            Jederzeit kündbar über die Kontoeinstellungen.
        </p>

        <h2 class="text-xl font-semibold mt-8 mb-4">6. Haftung</h2>
        <p>
            Keine Garantie für Datenrichtigkeit. Haftung beschränkt auf Vorsatz und grobe Fahrlässigkeit.
        </p>

        <h2 class="text-xl font-semibold mt-8 mb-4">7. Datennutzung</h2>
        <p>
        ...
        <h2 class="text-xl font-semibold mt-8 mb-4">8. Anwendbares Recht</h2>
        <p>
        ...
        <p>
            CreativeCodingSolutions, Karsten Brauner<br>
