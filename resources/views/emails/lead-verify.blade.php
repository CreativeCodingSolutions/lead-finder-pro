                ...
                <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                    <tr>
                        <td style="text-align: center; padding: 20px 0;">
                            <a href="{{ $verifyUrl }}" style="display: inline-block; background-color: #4f46e5; color: #ffffff; text-decoration: none; padding: 12px 32px; border-radius: 6px; font-size: 14px; font-weight: 600;">
                                Email bestätigen
                            </a>
                        </td>
                    </tr>
        ...
        <tr>
            <td style="text-align: center; padding-top: 24px;">
                <p style="font-size: 12px; color: #9ca3af; margin: 0;">
                    © {{ date('Y') }} LeadFinderPro. Ein Projekt von CreativeCodingSolutions.
                </p>
