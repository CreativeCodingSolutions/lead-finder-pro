<?php $__env->startSection('title', 'Neuer Export Schedule - Lead Finder Pro'); ?>

<?php $__env->startSection('content'); ?>
<div class="max-w-2xl mx-auto">
    <div class="mb-6">
        <a href="<?php echo e(route('exports.schedule.index')); ?>" class="text-sm text-gray-500 hover:text-indigo-600 transition">
    ...
    <div class="bg-white rounded-xl shadow-sm border p-6">
        ...
        <form action="<?php echo e(route('exports.schedule.store')); ?>" method="POST" class="space-y-5">
            <?php echo csrf_field(); ?>

            <!-- Name -->
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-1">Schedule-Name <span class="text-red-500">*</span></label>
                <input type="text" name="name" value="<?php echo e(old('name')); ?>" required placeholder="z.B. Wöchentlicher Restaurant-Report"
            ...
            <div>
                ...
                <div class="grid grid-cols-3 gap-3">
                    <label class="relative cursor-pointer">
                        <input type="radio" name="frequency" value="daily" class="peer sr-only" <?php echo e(old('frequency') === 'daily' ? 'checked' : ''); ?>>
                    ...
                    <label class="relative cursor-pointer">
                        <input type="radio" name="frequency" value="weekly" class="peer sr-only" <?php echo e(old('frequency') === 'weekly' ? 'checked' : ''); ?>>
                        <div class="text-center py-3 px-4 border-2 rounded-lg peer-checked:border-indigo-500 peer-checked:bg-indigo-50 hover:bg-gray-50 transition">
                    ...
                    <label class="relative cursor-pointer">
                        <input type="radio" name="frequency" value="monthly" class="peer sr-only" <?php echo e(old('frequency', 'monthly') === 'monthly' ? 'checked' : ''); ?>>
                        <div class="text-center py-3 px-4 border-2 rounded-lg peer-checked:border-indigo-500 peer-checked:bg-indigo-50 hover:bg-gray-50 transition">
            ...
            <div>
                ...
                <div class="grid grid-cols-2 gap-3">
                    <label class="relative cursor-pointer">
                        <input type="radio" name="format" value="csv" class="peer sr-only" <?php echo e(old('format', 'csv') === 'csv' ? 'checked' : ''); ?>>
                    ...
                    <label class="relative cursor-pointer">
                        <input type="radio" name="format" value="json" class="peer sr-only" <?php echo e(old('format') === 'json' ? 'checked' : ''); ?>>
                        <div class="flex items-center gap-3 py-3 px-4 border-2 rounded-lg peer-checked:border-indigo-500 peer-checked:bg-indigo-50 hover:bg-gray-50 transition">
            ...
            <div class="grid grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="text" name="industry" value="<?php echo e(old('industry')); ?>" placeholder="z.B. Restaurants"
                        class="w-full px-4 py-2.5 border rounded-lg text-sm focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 outline-none">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Stadt</label>
                    <input type="text" name="city" value="<?php echo e(old('city')); ?>" placeholder="z.B. Berlin"
                        class="w-full px-4 py-2.5 border rounded-lg text-sm focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 outline-none">
                </div>
            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /opt/data/founder/apps/lead-finder-pro/resources/views/modules/export-scheduler/create.blade.php ENDPATH**/ ?>