...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'LeadFinderPro — Branchen-Leads für Ihren Vertrieb'); ?></title>
    <meta name="description" content="<?php echo $__env->yieldContent('meta_description', 'Finden Sie qualifizierte Leads aus OpenStreetMap — nach Branche und Ort. Für Marketing-Agenturen und Vertriebsteams in Deutschland, Österreich und Schweiz.'); ?>">
    ...
    <meta name="keywords" content="<?php echo $__env->yieldContent('meta_keywords', 'Leads finden, Vertrieb, Marketing-Agenturen, B2B Leads, OpenStreetMap, Branchenbuch, DACH, Lead-Generierung'); ?>">

    <!-- Open Graph -->
    <meta property="og:title" content="<?php echo $__env->yieldContent('og_title', 'LeadFinderPro — Branchen-Leads für Ihren Vertrieb'); ?>">
    <meta property="og:description" content="<?php echo $__env->yieldContent('og_description', 'Finden Sie qualifizierte Leads aus OpenStreetMap — nach Branche und Ort. Für Agenturen und Vertriebsteams in DACH.'); ?>">
...
<body class="bg-gray-50 min-h-screen">
            ...
            <div class="flex justify-between h-16">
                <div class="flex items-center">
                    ...
                    <div class="hidden md:flex ml-10 gap-1">
                        <a href="<?php echo e(route('dashboard')); ?>" class="px-3 py-2 rounded-md text-sm font-medium <?php echo e(request()->routeIs('dashboard') ? 'bg-indigo-50 text-primary' : 'text-gray-600 hover:text-gray-900 hover:bg-gray-50'); ?>">
                            <i class="fa-solid fa-chart-pie mr-1"></i> Dashboard
                        </a>
                        <a href="<?php echo e(route('search.create')); ?>" class="px-3 py-2 rounded-md text-sm font-medium <?php echo e(request()->routeIs('search.*') ? 'bg-indigo-50 text-primary' : 'text-gray-600 hover:text-gray-900 hover:bg-gray-50'); ?>">
                            <i class="fa-solid fa-magnifying-glass mr-1"></i> Suche
                        </a>
                        <a href="<?php echo e(route('leads.index')); ?>" class="px-3 py-2 rounded-md text-sm font-medium <?php echo e(request()->routeIs('leads.*') ? 'bg-indigo-50 text-primary' : 'text-gray-600 hover:text-gray-900 hover:bg-gray-50'); ?>">
                            <i class="fa-solid fa-list mr-1"></i> Leads
                        </a>
                    </div>
                </div>
                <div class="flex items-center gap-3">
                    <a href="<?php echo e(route('profile.show')); ?>" class="text-sm text-gray-600 hover:text-primary transition">
                        <i class="fa-solid fa-user-circle mr-1"></i><?php echo e(Auth::user()->name); ?>
    ...
    <nav class="md:hidden fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 z-50">
        <div class="flex justify-around py-2">
            <a href="<?php echo e(route('dashboard')); ?>" class="flex flex-col items-center px-3 py-1 <?php echo e(request()->routeIs('dashboard') ? 'text-primary' : 'text-gray-400'); ?>">
                <i class="fa-solid fa-chart-pie text-lg"></i>
                <span class="text-xs mt-1">Dashboard</span>
            </a>
            <a href="<?php echo e(route('search.create')); ?>" class="flex flex-col items-center px-3 py-1 <?php echo e(request()->routeIs('search.*') ? 'text-primary' : 'text-gray-400'); ?>">
                <i class="fa-solid fa-magnifying-glass text-lg"></i>
                <span class="text-xs mt-1">Suche</span>
            </a>
            <a href="<?php echo e(route('leads.index')); ?>" class="flex flex-col items-center px-3 py-1 <?php echo e(request()->routeIs('leads.*') ? 'text-primary' : 'text-gray-400'); ?>">
...
<?php /**PATH /opt/data/founder/apps/lead-finder-pro/resources/views/layouts/app.blade.php ENDPATH**/ ?>