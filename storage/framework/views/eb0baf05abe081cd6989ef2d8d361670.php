    ...
    <div class="max-w-md mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div class="text-center">
            ...
            <p class="text-gray-600 mb-6">
                Wir haben einen Verifizierungslink an <strong><?php echo e($lead->email); ?></strong> gesendet.
            ...
            <form action="<?php echo e(route('lead.verification.resend')); ?>" method="POST" class="inline">
                <?php echo csrf_field(); ?>
...
<?php /**PATH /opt/data/founder/apps/lead-finder-pro/resources/views/auth/verify-lead.blade.php ENDPATH**/ ?>