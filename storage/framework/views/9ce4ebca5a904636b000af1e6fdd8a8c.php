<?php $__env->startSection('title', 'Passwort zurücksetzen - Lead Finder Pro'); ?>
        ...
        <div class="bg-white rounded-xl shadow-lg p-8">
            ...
            <form method="POST" action="<?php echo e(route('password.update')); ?>" class="space-y-5">
                ...
                <div>
                    ...
                    <input type="email" name="email" value="<?php echo e(old('email', $email)); ?>" required readonly
...
<?php echo $__env->make('layouts.auth', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /opt/data/founder/apps/lead-finder-pro/resources/views/auth/passwords/reset.blade.php ENDPATH**/ ?>