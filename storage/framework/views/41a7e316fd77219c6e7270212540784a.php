...
<body class="bg-white text-gray-800 font-sans">
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <div class="mb-8">
            ...
            <p class="text-gray-600"><?php echo e($industry->name); ?> in <?php echo e($city); ?>, <?php echo e($country); ?> — <?php echo e($totalDemo); ?> Beispiel-Leads</p>
        </div>
                ...
                <tbody class="divide-y divide-gray-100">
                    <?php $__currentLoopData = $leads; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lead): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-4 py-3 text-gray-600">
                                <?php if($lead['phone']): ?>
                                    <span class="block"><?php echo e($lead['phone']); ?></span>
                                <?php endif; ?>
                                <?php if($lead['email']): ?>
                                    <span class="block text-blue-600"><?php echo e($lead['email']); ?></span>
                                <?php endif; ?>
                            </td>
                            <td class="px-4 py-3">
                                <?php if($lead['website']): ?>
...
<?php /**PATH /opt/data/founder/apps/lead-finder-pro/resources/views/demo/results.blade.php ENDPATH**/ ?>