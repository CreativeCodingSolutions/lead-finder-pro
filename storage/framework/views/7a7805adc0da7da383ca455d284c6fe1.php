<?php $__env->startSection('title', 'Kaltakquise skalieren: Von 50 zu 500 Mails pro Monat — ohne Spam | LeadFinderPro Blog'); ?>
<?php $__env->startSection('meta_description', 'Wie B2B-Agenturen ihre Akquise von 50 auf 500+ personalisierte Mails pro Monat skalieren — ohne Spam, DSGVO-konform, mit echten Ergebnissen.'); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /opt/data/founder/apps/lead-finder-pro/resources/views/blog/cold-outreach-skalieren-500-mails-pro-monat.blade.php ENDPATH**/ ?>